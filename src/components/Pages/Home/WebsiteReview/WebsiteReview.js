...
import img from '../../../image/review-website.webp'

const WebsiteReview = () => {
    return (
        <div>
            <h2 className='text-3xl text-center'>Review On My Website</h2>            
                                ...
                                <div className="card flex-shrink-0 w-full max-w-sm bg-base-100 py-5 ">
                                    ...
                                    <form  className='grid justify-center'>
                                        <div className='grid grid-cols-1 gap-4'>
                                            ...
                                            <input name='photo' type="text" placeholder="Your Photo"  className="input input-bordered input-success " required  />
